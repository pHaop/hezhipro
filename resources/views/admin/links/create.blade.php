...
@section('content')
    ...
    <div class="x-body">
        <form class="layui-form" method="post" action="/admin/links" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{csrf_token()}}">
            <input type="hidden" name="status" value="0">
            <input type="hidden" name="addtime" value="{{date('Y-m-d H:i:s',time())}}">
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                    <span class="x-red">*</span>添加友链名称
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="urlname" name="urlname" required="" lay-verify="required"
