...
<div class="x-body">
    <form class="layui-form" method="post" action="/admin/links/{{$rs->id}}" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="urlname" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{$rs->urlname}}">
            </div>
            <br/>
