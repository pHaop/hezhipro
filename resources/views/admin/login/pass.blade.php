...
<html>
  ...
  <body>
    ...
    <div class="mws-form-message info">
        <font color="red" size="13px">{{session('error')}}</font>
    </div>
    @endif
        <form class="layui-form" method="post" action="/admin/dopass">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="password" id="L_repass" name="tppass" required="" lay-verify="required"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              {{csrf_field()}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button  class="layui-btn" lay-filter="save" lay-submit="" onclick="jiao()">
                  修改
              </button>
          </div>
      </form>
