  ...
  <body>
    ...
    <div class="mws-form-message info">
      ...
      <div class="layui-row">
        ...
        <form class="layui-form layui-col-md12 x-so" action="/admin/perm" method="get">
        ...
        <tbody>
          ...
          <tr height="30px">
            ...
            <td class="td-manage">
              <ul>
              <li id='ull'>
              <a title="编辑"  onclick="x_admin_show('编辑','/admin/perm/{{$v->id}}/edit')" href="javascript:;">
    ...
    <script>
         $(".demo_2").click(function(){
          ...
          $.get('/admin/perm/'+rs,function(data){
